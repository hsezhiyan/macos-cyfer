...
- (Boolean) isBrowser: (NSString*) appName {
    if ([appName isEqualToString:@"Google Chrome"] || [appName isEqualToString:@"Safari"] || [appName isEqualToString:@"Opera"]) {
        return true;
    } else {
        return false;
    }
...
- (NSString*) frontmostWebpageURL: (NSString*) appName {
    ...
    } else if ([appName isEqualToString: @"Google Chrome"] || [appName isEqualToString:@"Opera"]) {
